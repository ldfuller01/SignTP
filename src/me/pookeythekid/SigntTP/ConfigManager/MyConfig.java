package me.pookeythekid.SigntTP.ConfigManager;
...
/**
 * 
 * @author AppljuzeProgramming
 * 
 * This class is not my own. Tutorial of origin can be found here: https://www.youtube.com/watch?v=pyBM83LbG9U
 * The class can be viewed at plain text on this link provided in the tutorial's description: https://dl.dropboxusercontent.com/u/48481378/MyConfig.java
 *
 */
public class MyConfig 
{
    ...
    public float getLong(String path) {return this.config.getLong(path);}
    
    public float getLong(String path, long def) {return this.config.getLong(path, def);}
