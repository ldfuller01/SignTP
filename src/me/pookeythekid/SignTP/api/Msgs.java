...
public class Msgs {
	...
	public String EcoOffError() {
		...
		return (Tag() + ChatColor.RED + "Error: " + ChatColor.GOLD
				+ "Economy is set to true in the SignTP config, but there was an error with Vault linkage. "
				+ "SignTP can't use economy until this error is resolved.");
